...
public static class GenerationConfigUtils
{
    public static float GetTemperature(Context context)
    {
        ...
        return prefs.GetFloat(context.GetString(Resource.String.pref_key_temperature), 0.2f);
    }
    ...
    {
        var prefs = PreferenceManager.GetDefaultSharedPreferences(context)!;
        return prefs.GetInt(context.GetString(Resource.String.pref_key_top_k), 16);
    }
    ...
    {
        var prefs = PreferenceManager.GetDefaultSharedPreferences(context)!;
        return prefs.GetInt(context.GetString(Resource.String.pref_key_max_output_tokens), 256);
    }
